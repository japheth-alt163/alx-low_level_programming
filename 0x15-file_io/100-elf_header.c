...
/**
 * elf_entry - it prints print entry point address
 * @buffer: strings containing the entry point address
...
/**
 * main - it copy file's contents to another file
 * @argc: argument count
